...
import * as ExperienceColumn
  from "../components/results-table/experience-column";
...
const makeDataCellSetup = (column, defaultProps) =>
  makeSetup(column.DataCell.WrappedComponent, defaultProps, {
...
describe("<ResultsTable>", () => {
  ...
  it("filters out rows with null prices", () => {
    const { wrapper } = setup({
      results: [{ id: 1, current_price: null }, { id: 2, current_price: 1 }]
    });
